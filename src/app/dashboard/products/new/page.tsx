      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto pb-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-card shadow rounded-lg p-6">
                  ...
                  <div className="relative rounded-md">
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <input
                          type="number"
                          className="block w-full rounded-md border border-input bg-background pl-7 pr-12 py-2 text-sm text-foreground ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                          placeholder="0.00"
                          step="0.01"
                          min="0"
            ...
            {/* Features Section */}
            <div className="space-y-4 pt-4 border-t border-border">
              <h2 className="text-lg font-medium text-card-foreground">Features (Optional)</h2>
                ...
                {features.length > 0 && (
                  <ul className="mt-4 space-y-2">
                    {features.map((feature, index) => (
                      <li key={index} className="flex items-center justify-between px-3 py-2 bg-muted rounded-md">
            ...
            <div className="space-y-4 pt-4 border-t border-border">
              <h2 className="text-lg font-medium text-card-foreground">Specifications (Optional)</h2>
                    ...
                    <table className="min-w-full divide-y divide-border">
                      ...
                      <tbody className="bg-card divide-y divide-border">
                        {Object.entries(specifications).map(([key, value]) => (
                          <tr key={key}>
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground">{key}</td>
